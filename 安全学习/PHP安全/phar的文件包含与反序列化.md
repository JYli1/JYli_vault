...
![600](assets/phar的文件包含与反序列化/file-20251212232652582.png)
...
![600](assets/phar的文件包含与反序列化/file-20251212232652581.png)
...
![600](assets/phar的文件包含与反序列化/file-20251212232652579.png)
...
![600](assets/phar的文件包含与反序列化/file-20251212232652574.png)
...
![500](assets/phar的文件包含与反序列化/file-20251212232652572.png)

当我们执行这个脚本后（区别就是stub里面加了一个头）

可以看到右边`<?php`前面有一个十六进制头，我们用file命令看一下这个文件

![600](assets/phar的文件包含与反序列化/file-20251212232652570.png)

看到系统认为他是一个GIF文件，这样可以绕过一些过滤。

## 5.3 利用方式

![500](assets/phar的文件包含与反序列化/file-20251212232652567.png)
...
![500](assets/phar的文件包含与反序列化/file-20251212232652559.png)
